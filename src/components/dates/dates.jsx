...
export default function Dates(props) {
  ...
  return (
    <div className="h-screen w-3/4 flex flex-col items-center justify-center container">
      ...
      <div className="w-3/5 h-1/2 bg-base-300 rounded-2xl box-content p-10 flex flex-col justify-between">
          <div className="w-full h-full flex justify-right">
            <form action="" className="w-full h-full flex flex-col justify-evenly items-center">
              <input
                type="text"
                id="nameId"
                className="w-1/2 p-2 font-semibold bg-base-100"
                maxLength={28}
              ...
              />
                <div className="w-full flex justify-center">
                  <input
                    ...
                    max={23}
                    min={0}
                    className="w-1/5 mr-16 font-semibold bg-base-100 text-center text-5xl horas"
                    value={dateHours}
                  ...
                  <input
                    ...
                    max={59}
                    min={0}
                    className="w-1/5 font-semibold bg-base-100 text-center text-5xl horas"
                    value={dateMinutes}
